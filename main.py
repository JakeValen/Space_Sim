...
while running:
    ...
    button1 = s.Button(game_screen,(10,700), 75, 30,button_list=buttons,on_click_function=quit,one_press=True,text="Quit")
    ...
    button3 = s.Button(game_screen,(10,600), 150, 30, button_list=buttons, on_click_function=add_star,one_press=True, text="Add Star")
